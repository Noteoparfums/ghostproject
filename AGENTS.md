...
|---|---|---|---|
| `AGENTS.md` | Persistent project memory and mandatory handoff protocol | Tracked; current session Git facts corrected and identity failure recorded | Validate, commit with the existing repository author identity, and push |
