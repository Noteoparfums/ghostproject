...
async function assertMigrationsCurrent() {
  ...
  try {
    ...
    const appliedCount = (rows as any[])[0]?.count ?? 0;
            ...
            if (gen) {
              ...
              try {
                ...
                if (cost > 0) {
                  ...
                  const current = Number((ledgerRows as any[])[0]?.bal ?? 0);
