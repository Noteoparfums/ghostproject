...
const topupPackSlugs = Object.keys(TOPUP_PACKS);
/**
...
export const checkoutSchema = z
    ...
    .refine((v) => Boolean(v.topup_pack) !== Boolean(v.plan_slug), 'Provide either a plan_slug or a topup_pack, not both')
    .refine((v) => (v.plan_slug ? Boolean(v.interval) : true), 'interval is required when purchasing a plan');
