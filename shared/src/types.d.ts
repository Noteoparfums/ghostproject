 ...
 */
export declare const SUBSCRIPTION_TRANSITIONS: Record<SubscriptionStatus, SubscriptionStatus[]>;
export declare function isLegalSubscriptionTransition(from: SubscriptionStatus, to: SubscriptionStatus): boolean;
